...
public class MyReceptionController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Reception r = new Reception((String)request.getSession().getAttribute("userId"), category);
		...
		request.getRequestDispatcher("views/uesr/receptionBoard.jsp").forward(request, response);
	}
