<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="mypage.member.model.vo.Member"%>
<%
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link" href="<%=contextPath %>/공통/main.html">로그아웃</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="mypage-main-container">
            ...
            <div class="mypage-main-list">
                <div class="mypage-list-title">
                    <div class="mypage-list-menu"><a href="<%=contextPath %>/views/mypageView/mypage/MyPageMain.jsp">방문 내역</a>
                        <div class="mypage-list3-line1"></div>
                    </div>
                    <div class="mypage-list-menu"><a href="<%=contextPath %>/views/mypageView/mypage/MyPageReservStatus.jsp">나의 예약</a>
                        <div class="mypage-list3-line2"></div>
                    </div>
                    <div class="mypage-list-menu"><a href="<%=contextPath %>/views/mypageView/mypage/MyPageEditInfo.jsp">내 정보 수정</a>
