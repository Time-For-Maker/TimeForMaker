      ...
      <div class="user-login-container">
        ...
        <div class="user-login-condition-wapper">
          ...
          <div class="user-login-condition-contents">
            <p style="font-weight: 600 !important; font-size: 17px !important;"> 타임포메이커는 고객님을 보호합니다.</p>
            <p style="font-size: 14px !important;">본 약관은 타임포메이커 홈페이지 서비스 이용과 관련하여<br>
              필요한 사항을 규정합니다.</p>
            <p style="font-weight: 600 !important; font-size: 17px !important;">제 1장 총칙</p>
          </div>
          <!-- 약관 문구 끝-->
